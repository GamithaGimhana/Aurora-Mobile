...
const QuickAction = ({
  ...
  >
    <View
      className={`w-14 h-14 ${color} rounded-2xl items-center justify-center mr-4 shadow-sm`}
    >
        ...
        >
          ...
          <View className="bg-indigo-600 rounded-[40px] p-8 mb-10 overflow-hidden shadow-xl shadow-indigo-200">
            ...
            <View className="flex-row items-center mb-6">
              ...
              <Text className="text-white/80 font-bold ml-2 text-xs uppercase tracking-widest">
                Study Streak: 5 Days
              </Text>
            </View>
